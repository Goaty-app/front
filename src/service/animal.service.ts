...
import type { Animal, UpdateOrCreateAnimal } from '@/interface/animal.interface';
import type { BirthResponse, UpdateBirth, CreateBirth, Breeding, CreateOrUpdateBreeding} from '@/interface/birth.interface';
...
export const createAnimal = async (herdId: string, animal: UpdateOrCreateAnimal) => {
    return httpApi.post<Animal>(`/herds/${herdId}/animals`, animal, {
        headers: { 'Content-Type': 'application/json' },
    });
};

export const updateAnimal = async (id: string, animal: UpdateOrCreateAnimal) => {
...
export const searchAnimals = async (params: { name?: string; gender?: string }) => {
...
export const updateBreeding = async (breedingId: string, breeding: CreateOrUpdateBreeding) => {
