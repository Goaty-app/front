...
const AnimalTable: React.FC<{ animals: Array<Animal> }> = ({
  animals: animals,
}) => (
  <TableContainer
    component={Paper}
    ...
    <Table size="small">
      <TableHead>
        <TableRow>
          ...
          <TableCell className="bg-header">
            <Typography.Text className="dark-text">Genre</Typography.Text>
          </TableCell>
          <TableCell className="bg-header">
            <Typography.Text className="dark-text">ID</Typography.Text>
          </TableCell>
          <TableCell className="bg-header">
            <Typography.Text className="dark-text">Troupeau</Typography.Text>
          </TableCell>
        </TableRow>
      </TableHead>
      <TableBody>
