...
const AnimalMainContent: React.FC<{ animal: Animal }> = ({animal}) => {
    return (
        <Containers.Simple className="flex flex-col gap-4">
            ...
            <Labeled.LabeledText label="Nom" value={animal.name !== null ? animal.name : "Larry"} />
            ...
            <Labeled.LabeledText label="Pays d'origine" value={animal.originCountry}/>
            ...
            <Labeled.LabeledTextArea readOnly className="flex flex-col" label="Notes" value={animal.behaviorNotes !== null ? animal.behaviorNotes : ""}/>
        </Containers.Simple>
    )
}
